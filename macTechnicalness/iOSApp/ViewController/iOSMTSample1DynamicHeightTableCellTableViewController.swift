...
class iOSMTSample1DynamicHeightTableCellTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        */
        ...
        @comment    計測用のセルを取得
        */
        self.stubCell = self.tableView.dequeueReusableCell(withIdentifier: iOSMTSample1DynamicHeightTableViewCell.cellIdentifier()) as? iOSMTSample1DynamicHeightTableViewCell
        ...
        */
        ...
        self.dataObjectArray.add(data1Dictionary)
        self.dataObjectArray.add(data2Dictionary)
        self.dataObjectArray.add(data3Dictionary)
        self.dataObjectArray.add(data4Dictionary)
    ...
    func configureCell(_ cell: iOSMTSample1DynamicHeightTableViewCell, atIndex:IndexPath)
    {
        let dataObject: NSDictionary = (self.dataObjectArray[atIndex.row] as? NSDictionary)!
        
        cell.mainLabel.text = dataObject.value(forKey: "message") as? String
        
        let date: Date = (dataObject.value(forKey: "date") as? Date)!
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "yyyy/mm/dd HH:mm:ss"
        cell.subLabel.text = dateFormatter.string(from: date)
    }

    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        
        let cell = tableView.dequeueReusableCell(withIdentifier: iOSMTSample1DynamicHeightTableViewCell.cellIdentifier(), for: indexPath) as! iOSMTSample1DynamicHeightTableViewCell
